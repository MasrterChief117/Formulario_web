           ...
           <div class="logo mb-3">
            ...
            <form action="" method="post" name="login" novalidate="novalidate">
                <div>
                    ...
                    <input class="form-control" id="nombreTipo" type="text" name="nombreTipo" placeholder="Ingrese Tipo"/>
                  </div>  
                  <div>
                    <label for="nombre">ID tipo:</label>
                    <input class="form-control" id="IDTipo" type="number" name="IDTipo" placeholder="Ingrese ID de Tipo"/>
                  </div>
