           ...
           <div class="logo mb-3">
            ...
            <form action="" method="post" name="login" novalidate="novalidate">
                <div>
                    ...
                    <input class="form-control" id="nombre" type="text" name="nombre" placeholder="Ingrese nombre"/>
                  </div>  
                  <div>
                    <label for="nombre">ID nombre:</label>
                    <input class="form-control" id="IDNombre" type="number" name="IDNombre" placeholder="Ingrese ID"/>
                  </div>
